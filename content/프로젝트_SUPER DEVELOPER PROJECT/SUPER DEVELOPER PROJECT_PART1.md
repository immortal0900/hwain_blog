...
2026년 3월에 나온 **Anthropic Harness V2**[^2]는 흐름이 다르다. 역할마다 세션은 분리하되, **Generator가 스프린트를 나누지 않고** 하나의 세션에서 연속 작업**을 진행하며, 컨텍스트가 길어지면 **SDK의 자동 컴팩션(compaction, 긴 컨텍스트를 요약으로 압축하는 기능)** 으로 축소시킨다.
...
![[Pasted image 20260423095224.png]]
...
|Sprint|세션 수|누적 Latency|Input|Output|Σ Tokens|캐시 제외|캐시 포함|
|---|---|---|---|---|---|---|---|
|**sprint-1**|8|1h 37m 42s|32,694|273,482|**31,952,167**|$7.00|**$31.92**|
|**sprint-2**|1|24m 30s|7,349|95,578|**25,121,315**|$2.43|**$22.13**|
|**sprint-3**|2|33m 02s|32,553|134,601|**15,593,319**|$3.53|**$15.68**|
|**sprint-4**|1|20m 46s|44,018|81,729|**18,996,343**|$2.26|**$17.12**|
|**sprint-5**|1|2m 19s|19,946|6,104|**312,670**|$0.25|**$0.48**|
|**합계**|**13**|**≈ 2h 58m 19s**|**136,560**|**591,494**|**91,975,814**|**$15.47**|**$87.33**|
